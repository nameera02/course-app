import { VStack,Container,Button,FormLabel,Heading,Input,Box } from '@chakra-ui/react';
  ...
  return (
    <Container h={'95vh'}>
        <VStack h={`full`} justifyContent="center" spacing={'16'}>
            <Heading children={"Welcome to Course Academy"} />
            ...
            <Button fontSize={'sm'} variant="link">Forget Password</Button></Link>
            </Box>
            <Button my="4" colorScheme={'yellow'} type='submit'>Login</Button>
            <Box my="4">New User?{' '}
                <Link to="/register"><Button colorScheme={'yellow'} variant="link">Sign Up</Button>{' '}Here</Link>
            </Box>
            </form>
        </VStack>
    </Container>
